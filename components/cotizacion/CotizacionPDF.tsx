...
const styles = StyleSheet.create({
  ...
  cotizacionSection: { width: 100, padding: 8, justifyContent: "center", alignItems: "center", borderLeftWidth: 1, borderLeftColor: COLORS.border, backgroundColor: COLORS.headerBg },
  cotizacionLabel: { fontSize: 8, fontWeight: "bold", color: COLORS.textMedium, textTransform: "uppercase" },
  cotizacionNumero: { fontSize: 13, fontWeight: "bold", color: COLORS.primary, marginTop: 2 },
  cotizacionFecha: { fontSize: 6, color: COLORS.textLight, marginTop: 2 },
...
export default function CotizacionPDF({ id, cliente, cabecera, items, fechaEmision, horaEmision }: CotizacionPDFProps) {
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.headerContainer}>
          ...
          <View style={styles.cotizacionSection}>
            ...
            <Text style={styles.cotizacionFecha}>{fechaEmision} - {horaEmision}</Text>
          </View>
        </View>
        ...
        <View style={styles.clienteContainer}>
          ...
          <View style={styles.infoBox}>
            ...
            <View style={styles.infoBody}>
              <View style={styles.infoField}><Text style={styles.infoFieldLabel}>Fecha:</Text><Text style={styles.infoFieldValue}>{cabecera.fechaEmision}</Text></View>
              <View style={styles.infoField}><Text style={styles.infoFieldLabel}>Moneda:</Text><Text style={styles.infoFieldValue}>{cabecera.moneda}</Text></View>
              <View style={styles.infoField}><Text style={styles.infoFieldLabel}>Condición:</Text><Text style={styles.infoFieldValue}>{cabecera.condicionPago}</Text></View>
              <View style={styles.infoField}><Text style={styles.infoFieldLabel}>Vigencia:</Text><Text style={[styles.infoFieldValue, { color: COLORS.success, fontWeight: "bold" }]}>Válido 7 días</Text></View>
            </View>
          </View>
        </View>
        ...
        <View style={styles.observacionesSection}>
          ...
          <Text style={styles.observacionLine}>• Cotización válida por 7 días.</Text>
        </View>
        ...
        <View style={styles.footerFixed} fixed>
          ...
          <Text style={styles.footerText}>Esta cotización no constituye comprobante de pago.</Text>
        </View>
      </Page>
    </Document>
  );
